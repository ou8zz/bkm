...
Page.prototype.view = function(){
    ...
    return '<div name="laypage'+ laypage.v +'" class="laypage_main laypageskin_'+ (conf.skin ? (function(skin){
    	...
    	var tt = conf.total?'<label>&#x5171;'+conf.total+'&#x6761;</label>':'';
        return conf.skip 
        ? '<span class="laypage_total">'+tt+'&nbsp;<label>&#x5230;&#x7B2C;</label><input type="number" min="1" onkeyup="this.value=this.value.replace(/\\D/, \'\');" class="laypage_skip"><label>&#x9875;</label>'
