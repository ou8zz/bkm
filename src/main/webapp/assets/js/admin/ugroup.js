...
var Ugroup = function() {
	 ...
	 * @param obj
	 */
	var searchUgroup = function (obj) {
		var searchForm = null;
		if(obj==undefined) searchForm = $("#searchForm");
		else searchForm = $(obj).closest("#searchForm");
		getUgroups(obj, searchForm.serializeJson());
	}
	
	var getUgroups = function (obj, pas) {
...
$(function() {
	// 默认查询事件
	params = {'func':'getUgroups', 'pageNum':1, 'pageSize':10};
	Ugroup.searchUgroup();
});