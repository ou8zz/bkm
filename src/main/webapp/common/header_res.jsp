...
<head>
	...
	<link rel="icon" type="image/png" href="../res/img/logo/cloud.png">
	<link rel="stylesheet" type="text/css" href="../res/css/cloud-admin.css" >
	<link rel="stylesheet" type="text/css" href="../res/css/themes/default.css" id="skin-switcher" >
	...
	<link rel="stylesheet" type="text/css" href="../res/css/zTreeStyle.css">
	<link rel="stylesheet" type="text/css" href="../res/js/select2/select2.min.css" />
<!-- 	<link rel='stylesheet' type='text/css' href='../res/css/font.css?family=Open+Sans:300,400,600,700'> -->
...
<header class="navbar clearfix navbar-fixed-top" id="header">
	<div class="container">
			<div class="navbar-brand">
				<!-- COMPANY LOGO -->
				<a href="index">
					<img src="../res/img/logo/logo.png" alt="Cloud Admin Logo" class="img-responsive" height="30" width="120">
				</a>
				<!-- /COMPANY LOGO -->
